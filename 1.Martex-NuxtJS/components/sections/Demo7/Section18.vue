<template>
    <section id="section18" class="features-section">
  ...
  export default {
    ...
    methods: {
      submitForm() {
        // Here you could add code to send the form to a backend
  ...
  .submit-button:hover {
    ...
    box-shadow: 0 4px 8px rgba(42, 70, 196, 0.2);
    color: black;
  }
